package flynas.androidchrome.testObjects;
...
//	public static By adult = By.xpath("//div[@class='main_con']/div[2]//descendant::form/div[3]/div/div");
	...
	public static By economyOW = By.xpath("//button[@class='btn selectflightbtn col1']");
	public static By flexOW = By.xpath("//button[@class='btn selectflightbtn col2']");
	public static By busOW = By.xpath("//button[@class='btn selectflightbtn col3']");
	...
	public static By selectseattittle = By.xpath("//h1[text()=' Select your seat' or ./text()=' إختيار المقعد' or ./text()=' Lütfen koltugunuzu secin']");
	...
	public static By passengers_incheckin = By.xpath("//input[@name='passenger']");
