...
public class TC10_OneAdultOnechildFlexCordshare extends BookingPageFlow{
	...
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"FL_WEB_10");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC_10_OneAdultOnechildFlexCordshare (String tripType, String origin, String dest, String deptDate,
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Select Seat", "Value"),"Credit Card",xls.getCellValue("Booking type", "Value"),xls.getCellValue("Booking Class", "Value"),"",
