...
public class TC19_agencyLoginRToneAdultoneChild extends BookingPageFlow {
	...
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"FL_WEB_19");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC_19_agencyLoginRToneAdultoneChild( String username,String password,String bookingClass,String mobilenum,String paymentType,
			String newDate,String pickDate,String rtnDate,String origin,String dest,String triptype,String adult,String child,String infant,
