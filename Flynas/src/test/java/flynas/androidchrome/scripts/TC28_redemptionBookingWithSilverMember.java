...
public class TC28_redemptionBookingWithSilverMember extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"FL_WEB_28");
	...
	public  void TC_28_redemptionBookingWithSilverMember(String tripType, String origin, String dest, 
		...
		try {
			...
			inputPassengerDetails(FlightType,totalpass,nationality,Doctypr,docNumber, naSmiles,Mobile,email,"silver","member",paymenttype);
