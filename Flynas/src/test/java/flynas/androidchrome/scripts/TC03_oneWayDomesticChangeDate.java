...
public class TC03_oneWayDomesticChangeDate extends BookingPageFlow {
	...
	public void TC_03_oneWayDomesticChangeDate(String strTripType, String strFlightType, String strOrigin,
			...
			String strNewDate, String charity,String Currency)throws Throwable{
				try{
					String description = "Validate One Way Domestic ChangeDate";
					...
					String strPNRChangeDate = changeDate(strPNR, strEmail, strMobile, "", strNewDate, strSelectSeat,strTotalPessenger,strBookingClass,0);
					...
					driver.close();
						...
						e.printStackTrace();
						Reporter.SuccessReport("TC_03_oneWayDomesticChangeDate", "Fail");
						driver.close();
					}
	}
