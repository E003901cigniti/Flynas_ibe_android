...
public class TC25_oneWayDomesticOneAdultCheckInTR extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"FL_WEB_25");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC_25_oneWayDomesticOneAdultCheckInTR(String tripType, String origin, String dest,String deptDate,String origin2,
		...
		try {
			...
			inputBookingDetails_Tarkish(tripType,origin, dest, deptDate , origin2, departure2, retdate,Adult, Child, infant,"","");
			...
			Reporter.SuccessReport("TC25_oneWayDomesticOneAdultCheckInTR", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.SuccessReport("TC25_oneWayDomesticOneAdultCheckInTR", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    	{xls.getCellValue("Trip Type", "Value"),
	    		...
	    		"Validate One way Domestic with one Adualt CheckIn in TR"}};
	}
