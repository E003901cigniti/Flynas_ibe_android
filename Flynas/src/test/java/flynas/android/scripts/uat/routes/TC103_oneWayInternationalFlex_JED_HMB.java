...
public class TC103_oneWayInternationalFlex_JED_HMB extends BookingPageFlow{
	...
	public  void TC_103_oneWayInternationalFlex_JED_HMB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC103_oneWayInternationalFlex_JED_HMB", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC103_oneWayInternationalFlex_JED_HMB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay International Flex_JED_HMB"}};
	}
