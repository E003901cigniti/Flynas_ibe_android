...
public class TC161_oneWayInternationalBusiness_MED_KWI extends BookingPageFlow{
	...
	public  void TC_161_oneWayInternationalBusiness_MED_KWI(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC161_oneWayInternationalBusiness_MED_KWI", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC161_oneWayInternationalBusiness_MED_KWI", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			...
			"Validate oneWay International Business_MED_KWI"}};
	}
