...
public class TC117_multiCityInternationalFlex_JED_ADA extends BookingPageFlow{
	...
	public  void TC_117_multiCityInternationalFlex_JED_ADA(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC117_multiCityInternationalFlex_JED_ADA", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC117_multiCityInternationalFlex_JED_ADA", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate Multicity International Flex_JED_ADA"}};
	}
