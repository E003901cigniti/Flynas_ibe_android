...
public class TC125_oneWayDomesticBusiness_RUH_JED extends BookingPageFlow{
	...
	public  void TC_125_oneWayDomesticBusiness_RUH_JED(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC125_oneWayDomesticBusiness_RUH_JED", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC125_oneWayDomesticBusiness_RUH_JED", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay Domestic Business_RUH_JED"}};
	}
