...
public class TC100_oneWayInternationalFlex_TIF_KWI extends BookingPageFlow{
	...
	public  void TC_100_oneWayInternationalFlex_TIF_KWI(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC100_oneWayInternationalFlex_TIF_KWI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC100_oneWayInternationalFlex_TIF_KWI", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay International Flex_TIF_KWI"}};
	}
