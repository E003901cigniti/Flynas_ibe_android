...
public class TC55_multiCityInternationalEconomy_JED_ADA extends BookingPageFlow{
	...
	public  void TC_55_multiCityInternationalEconomy_JED_ADA(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC55_multiCityInternationalEconomy_JED_ADA", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC55_multiCityInternationalEconomy_JED_ADA", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate Multicity International Economy_JED_ADA"}};
	}
