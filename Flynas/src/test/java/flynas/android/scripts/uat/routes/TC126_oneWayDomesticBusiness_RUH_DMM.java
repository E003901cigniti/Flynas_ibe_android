...
public class TC126_oneWayDomesticBusiness_RUH_DMM extends BookingPageFlow{
	...
	public  void TC_126_oneWayDomesticBusiness_RUH_DMM(String tripType, String origin, String dest, 
			...
			String bookingtype, String charity,String Currency, 
		...
		try {
			...
			Reporter.SuccessReport("TC126_oneWayDomesticBusiness_RUH_DMM", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC126_oneWayDomesticBusiness_RUH_DMM", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay Domestic Business_RUH_DMM"}};
	}
