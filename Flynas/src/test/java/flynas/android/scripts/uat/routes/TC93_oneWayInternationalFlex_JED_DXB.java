...
public class TC93_oneWayInternationalFlex_JED_DXB extends BookingPageFlow{
	...
	public  void TC_93_oneWayInternationalFlex_JED_DXB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC93_oneWayInternationalFlex_JED_DXB", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC93_oneWayInternationalFlex_JED_DXB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay International Flex_JED_DXB"}};
	}
