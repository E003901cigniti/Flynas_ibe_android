...
public class TC177_multiCityInternationalBusiness_JED_HTY extends BookingPageFlow{
	...
	public  void TC_177_multiCityInternationalBusiness_JED_HTY(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC177_multiCityInternationalBusiness_JED_HTY", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC177_multiCityInternationalBusiness_JED_HTY", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate Multicity International Business_JED_HTY"}};
	}
