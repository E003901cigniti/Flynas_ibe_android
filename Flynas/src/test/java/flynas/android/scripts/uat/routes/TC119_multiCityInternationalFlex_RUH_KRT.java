...
public class TC119_multiCityInternationalFlex_RUH_KRT extends BookingPageFlow{
	...
	public  void TC_119_multiCityInternationalFlex_RUH_KRT(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC119_multiCityInternationalFlex_RUH_KRT", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC119_multiCityInternationalFlex_RUH_KRT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate Multicity International Flex_RUH_KRT"}};
	}
