...
public class TC31_oneWayInternationalEconomy_JED_DXB extends BookingPageFlow{
	...
	public  void TC_31_oneWayInternationalEconomy_JED_DXB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC31_oneWayInternationalEconomy_JED_DXB", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC31_oneWayInternationalEconomy_JED_DXB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay International Economy_JED_DXB"}};
	}
