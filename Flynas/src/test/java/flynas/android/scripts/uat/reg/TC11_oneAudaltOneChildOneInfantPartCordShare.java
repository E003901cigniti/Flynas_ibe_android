...
public class TC11_oneAudaltOneChildOneInfantPartCordShare  extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataForAndroid"),"FL_WEB_11");

	@Test(dataProvider = "testData",groups={"Android"})
	public  void TC_11_oneAudaltOneChildOneInfantPartCordShare (String tripType, String origin, String dest, String deptDate,
			String origin2,String departure2,String retdate,String Audalt,String Child,String infant,String promo,String FlightType,
			String totalpass,String namtionality,String Doctypr,String docNumber ,String naSmiles,String Mobile,String email ,
			String SelectSeat,String paymenttype,String Bookingtype,String bookingclass,String Currency,String Description)
			throws Throwable {
		try {
			...
			e.printStackTrace();
			Reporter.failureReport("TC11_oneAudaltOneChildOneInfantPartCordShare", "Failed");
		}
	}
