...
public class TC106_roundTripInternationalFlex_JED_SSH extends BookingPageFlow{
	...
	public  void TC_106_roundTripInternationalFlex_JED_SSH(String tripType, String origin, String dest, 
			...
			String namtionality,String Doctypr,String docNumber,String naSmiles,String Mobile,String email ,
			String SelectSeat,String paymenttype,String bookingtype, String charity,String Currency,
			String Description
			) throws Throwable {
		try {
			...
			e.printStackTrace();
			Reporter.failureReport("TC106_roundTripInternationalFlex_JED_SSH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Origin", "Value44"),
	    		xls.getCellValue("Destination", "Value44"),
    			...
    			"Validate RoundTrip International Flex_JED_SSH"}};
	}
