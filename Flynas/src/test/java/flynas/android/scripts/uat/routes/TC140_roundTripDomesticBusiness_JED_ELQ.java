...
public class TC140_roundTripDomesticBusiness_JED_ELQ extends BookingPageFlow{
	...
	public  void TC_140_roundTripDomesticBusiness_JED_ELQ(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC140_roundTripDomesticBusiness_JED_ELQ", "Pass");
				
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC140_roundTripDomesticBusiness_JED_ELQ", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip Domestic Business_JED_ELQ"}};
	}
