...
public class TC164_oneWayInternationalBusiness_JED_HBE extends BookingPageFlow{
	...
	public  void TC_164_oneWayInternationalBusiness_JED_HBE(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC164_oneWayInternationalBusiness_JED_HBE", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC164_oneWayInternationalBusiness_JED_HBE", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			{xls.getCellValue("Trip Type", "Value"),
				xls.getCellValue("Origin", "Value40"),
				xls.getCellValue("Destination", "Value40"),
			...
			"Validate oneWay International Business_JED_HBE"}};
	}
