...
public class TC14_roundTripDomesticEconomy_JED_AHB extends BookingPageFlow{
	...
	public  void TC_14_roundTripDomesticEconomy_JED_AHB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC14_roundTripDomesticEconomy_JED_AHB", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC14_roundTripDomesticEconomy_JED_AHB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate RoundTrip Domestic Economy_JED_AHB"}};
	}
