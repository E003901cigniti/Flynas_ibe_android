...
public class TC138_roundTripDomesticBusiness_JED_AHB extends BookingPageFlow{
	...
	public  void TC_138_roundTripDomesticBusiness_JED_AHB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC138_roundTripDomesticBusiness_JED_AHB", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC138_roundTripDomesticBusiness_JED_AHB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Origin", "Value14"),
	    		xls.getCellValue("Destination", "Value14"),
    			...
    			"Validate RoundTrip Domestic Business_JED_AHB"}};
	}
