...
public class TC151_oneWayDomesticBusinessCheckIn_ABH_BHH extends BookingPageFlow{
	...
	public  void TC_151_oneWayDomesticBusinessCheckIn_ABH_BHH(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC151_oneWayDomesticBusinessCheckIn_ABH_BHH", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC151_oneWayDomesticBusinessCheckIn_ABH_BHH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay Domestic Business CheckIn_ABH_BHH"}};
	}
