...
public class TC43_oneWayInternationalEconomy_JED_LXR extends BookingPageFlow{
	...
	public  void TC_43_oneWayInternationalEconomy_JED_LXR(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC43_oneWayInternationalEconomy_JED_LXR", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC43_oneWayInternationalEconomy_JED_LXR", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Origin", "Value43"),
	    		xls.getCellValue("Destination", "Value43"),
    			...
    			"Validate oneWay International Economy_JED_LXR"}};
	}
