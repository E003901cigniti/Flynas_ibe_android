...
public class TC01_oneWayDomesticEconomy_RUH_JED extends BookingPageFlow{
	...
	public  void TC_01_oneWayDomesticEconomy_RUH_JED(String tripType, String origin, String dest,String deptDate, String origin2,
			...
			String email ,String SelectSeat,String paymenttype,String bookingtype,String charity,String Currency,String Description) throws Throwable {
		try {
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Payment Type", "Value2"),"",xls.getCellValue("Charity Donation", "Value"),xls.getCellValue("Currency", "Value"),
