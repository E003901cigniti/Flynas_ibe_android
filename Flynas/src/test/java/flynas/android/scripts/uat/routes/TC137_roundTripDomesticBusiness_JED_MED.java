...
public class TC137_roundTripDomesticBusiness_JED_MED extends BookingPageFlow{
	...
	public  void TC_137_roundTripDomesticBusiness_JED_MED(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC137_roundTripDomesticBusiness_JED_MED", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC137_roundTripDomesticBusiness_JED_MED", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate RoundTrip Domestic Business_JED_MED"}};
	}
