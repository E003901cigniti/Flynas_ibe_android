...
public class TC184_multiCityInternationalBusiness_RUH_BAH extends BookingPageFlow{
	...
	public  void TC_184_multiCityInternationalBusiness_RUH_BAH(String tripType, String origin, String dest, 
		...
		try {
			...
			validateCheckin();
			Reporter.SuccessReport("TC184_multiCityInternationalBusiness_RUH_BAH", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC184_multiCityInternationalBusiness_RUH_BAH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate Multicity International Business_RUH_BAH"}};
	}
