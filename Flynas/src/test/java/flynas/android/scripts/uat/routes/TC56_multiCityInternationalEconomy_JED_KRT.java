...
public class TC56_multiCityInternationalEconomy_JED_KRT extends BookingPageFlow{
	...
	public  void TC_56_multiCityInternationalEconomy_JED_KRT(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC56_multiCityInternationalEconomy_JED_KRT", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC56_multiCityInternationalEconomy_JED_KRT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate Multicity International Economy_JED_KRT"}};
	}
