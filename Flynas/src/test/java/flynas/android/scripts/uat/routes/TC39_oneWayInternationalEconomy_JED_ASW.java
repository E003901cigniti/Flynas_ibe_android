...
public class TC39_oneWayInternationalEconomy_JED_ASW extends BookingPageFlow{
	...
	public  void TC_39_oneWayInternationalEconomy_JED_ASW(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC39_oneWayInternationalEconomy_JED_ASW", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC39_oneWayInternationalEconomy_JED_ASW", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay International Economy_JED_ASW"}};
	}
