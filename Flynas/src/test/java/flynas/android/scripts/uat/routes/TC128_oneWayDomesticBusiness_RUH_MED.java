...
public class TC128_oneWayDomesticBusiness_RUH_MED extends BookingPageFlow{
	...
	public  void TC_128_oneWayDomesticBusiness_RUH_MED(String tripType, String origin, String dest, 
			String deptDate, String origin2,String departure2, String retdate,String Audalt,
			String Child,String infant, String promo, String strBookingClass,String FlightType,
			String totalpass,String namtionality,String Doctypr,String docNumber,String naSmiles,
			String Mobile,String email ,String SelectSeat,String paymenttype,String bookingtype, 
			String charity,String Currency, String Description) throws Throwable 
	{
		try {
			...
			Reporter.SuccessReport("TC128_oneWayDomesticBusiness_RUH_MED", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC128_oneWayDomesticBusiness_RUH_MED", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay Domestic Business_RUH_MED"}};
	}
