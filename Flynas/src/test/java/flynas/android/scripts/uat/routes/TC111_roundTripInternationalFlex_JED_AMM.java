...
public class TC111_roundTripInternationalFlex_JED_AMM extends BookingPageFlow{
	...
	public  void TC_111_roundTripInternationalFlex_JED_AMM(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC111_roundTripInternationalFlex_JED_AMM", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC111_roundTripInternationalFlex_JED_AMM", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate RoundTrip International Flex_JED_AMM"}};
	}
