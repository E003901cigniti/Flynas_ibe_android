...
public class TC06_oneWayDomesticEconomy_RUH_HAS extends BookingPageFlow{
	...
	public  void TC_06_oneWayDomesticEconomy_RUH_HAS(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC06_oneWayDomesticEconomy_RUH_HAS", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC06_oneWayDomesticEconomy_RUH_HAS", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay Domestic Economy_RUH_HAS"}};
	}
