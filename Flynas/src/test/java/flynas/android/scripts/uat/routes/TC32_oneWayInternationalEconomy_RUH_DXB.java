...
public class TC32_oneWayInternationalEconomy_RUH_DXB extends BookingPageFlow{
	...
	public  void TC_32_oneWayInternationalEconomy_RUH_DXB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC32_oneWayInternationalEconomy_RUH_DXB", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC32_oneWayInternationalEconomy_RUH_DXB", "Failed");
		}
	}
