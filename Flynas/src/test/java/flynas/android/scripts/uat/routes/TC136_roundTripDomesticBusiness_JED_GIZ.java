...
public class TC136_roundTripDomesticBusiness_JED_GIZ extends BookingPageFlow{
	...
	public  void TC_136_roundTripDomesticBusiness_JED_GIZ(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC136_roundTripDomesticBusiness_JED_GIZ", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC136_roundTripDomesticBusiness_JED_GIZ", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate RoundTrip Domestic Business_JED_GIZ"}};
	}
