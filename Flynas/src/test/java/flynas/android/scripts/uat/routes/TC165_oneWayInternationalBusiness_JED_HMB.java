...
public class TC165_oneWayInternationalBusiness_JED_HMB extends BookingPageFlow{
	...
	public  void TC_165_oneWayInternationalBusiness_JED_HMB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC165_oneWayInternationalBusiness_JED_HMB", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC165_oneWayInternationalBusiness_JED_HMB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			...
			"Validate oneWay International Business_JED_HMB"}};
	}
