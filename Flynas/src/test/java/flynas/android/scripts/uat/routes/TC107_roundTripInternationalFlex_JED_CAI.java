...
public class TC107_roundTripInternationalFlex_JED_CAI extends BookingPageFlow{
	...
	public  void TC_107_roundTripInternationalFlex_JED_CAI(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC107_roundTripInternationalFlex_JED_CAI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC107_roundTripInternationalFlex_JED_CAI", "Failed");
		}
	}
