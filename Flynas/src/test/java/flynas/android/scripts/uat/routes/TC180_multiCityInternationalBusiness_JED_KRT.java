...
public class TC180_multiCityInternationalBusiness_JED_KRT extends BookingPageFlow{
	...
	public  void TC_180_multiCityInternationalBusiness_JED_KRT(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC180_multiCityInternationalBusiness_JED_KRT", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC180_multiCityInternationalBusiness_JED_KRT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Origin", "Value56"),
	    		xls.getCellValue("Destination", "Value56"),
    			...
    			"Validate Multicity International Business_JED_KRT"}};
	}
