...
public class TC42_oneWayInternationalEconomy_RUH_HMB extends BookingPageFlow{
	...
	public  void TC_42_oneWayInternationalEconomy_RUH_HMB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC42_oneWayInternationalEconomy_RUH_HMB", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC42_oneWayInternationalEconomy_RUH_HMB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay International Economy_RUH_HMB"}};
	}
