...
public class TC176_multiCityInternationalBusiness_RUH_SAW extends BookingPageFlow{
	...
	public  void TC_176_multiCityInternationalBusiness_RUH_SAW(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC176_multiCityInternationalBusiness_RUH_SAW", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC176_multiCityInternationalBusiness_RUH_SAW", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate Multicity International Business_RUH_SAW"}};
	}
