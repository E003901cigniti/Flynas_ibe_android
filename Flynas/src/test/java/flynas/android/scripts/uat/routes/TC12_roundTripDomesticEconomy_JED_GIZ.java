...
public class TC12_roundTripDomesticEconomy_JED_GIZ extends BookingPageFlow{
	...
	public  void TC_12_roundTripDomesticEconomy_JED_GIZ(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC12_roundTripDomesticEconomy_JED_GIZ", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC12_roundTripDomesticEconomy_JED_GIZ", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate RoundTrip Domestic Economy_JED_GIZ"}};
	}
