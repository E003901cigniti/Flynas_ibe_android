...
public class TC112_roundTripInternationalFlex_RUH_AMM extends BookingPageFlow{
	...
	public  void TC_112_roundTripInternationalFlex_RUH_AMM(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC112_roundTripInternationalFlex_RUH_AMM", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC112_roundTripInternationalFlex_RUH_AMM", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate RoundTrip International Flex_RUH_AMM"}};
	}
