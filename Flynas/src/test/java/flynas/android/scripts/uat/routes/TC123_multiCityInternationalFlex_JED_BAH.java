...
public class TC123_multiCityInternationalFlex_JED_BAH extends BookingPageFlow{
	...
	public  void TC_123_multiCityInternationalFlex_JED_BAH(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC123_multiCityInternationalFlex_JED_BAH", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC123_multiCityInternationalFlex_JED_BAH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate Multicity International Flex_JED_BAH"}};
	}
