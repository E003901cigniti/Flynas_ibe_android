...
public class TC183_multiCityInternationalBusiness_DMM_KRT extends BookingPageFlow{
	...
	public  void TC_183_multiCityInternationalBusiness_DMM_KRT(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC183_multiCityInternationalBusiness_DMM_KRT", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC183_multiCityInternationalBusiness_DMM_KRT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate Multicity International Business_DMM_KRT"}};
	}
