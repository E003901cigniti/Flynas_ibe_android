...
public class TC116_multiCityInternationalFlex_RUH_HTY extends BookingPageFlow{
	...
	public  void TC_116_multiCityInternationalFlex_RUH_HTY(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC116_multiCityInternationalFlex_RUH_HTY", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC116_multiCityInternationalFlex_RUH_HTY", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate Multicity International Flex_RUH_HTY"}};
	}
