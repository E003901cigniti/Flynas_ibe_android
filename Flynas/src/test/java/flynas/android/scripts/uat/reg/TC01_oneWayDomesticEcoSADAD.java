...
public class TC01_oneWayDomesticEcoSADAD extends BookingPageFlow{
			...
			String paymenttype,String bookingtype, String charity,String Currency, String Description) throws Throwable 
	{
		try {
			...
			Reporter.SuccessReport("TC_01_oneWayDomesticEcoSADAD", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC_01_oneWayDomesticEcoSADAD", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate One way Domestic with one Adualt Economy"}};
	}
