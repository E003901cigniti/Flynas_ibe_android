...
public class TC94_oneWayInternationalFlex_RUH_DXB extends BookingPageFlow{
	...
	public  void TC_94_oneWayInternationalFlex_RUH_DXB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC94_oneWayInternationalFlex_RUH_DXB", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC94_oneWayInternationalFlex_RUH_DXB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay International Flex_RUH_DXB"}};
	}
