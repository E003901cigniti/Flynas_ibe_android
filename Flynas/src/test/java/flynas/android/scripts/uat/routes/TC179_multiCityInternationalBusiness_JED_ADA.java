...
public class TC179_multiCityInternationalBusiness_JED_ADA extends BookingPageFlow{
	...
	public  void TC_179_multiCityInternationalBusiness_JED_ADA(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC179_multiCityInternationalBusiness_JED_ADA", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC179_multiCityInternationalBusiness_JED_ADA", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Origin", "Value55"),
	    		xls.getCellValue("Destination", "Value55"),
    			...
    			"Validate Multicity International Business_JED_ADA"}};
	}
