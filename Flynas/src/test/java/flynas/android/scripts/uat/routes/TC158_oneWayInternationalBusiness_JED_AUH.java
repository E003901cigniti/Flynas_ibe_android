...
public class TC158_oneWayInternationalBusiness_JED_AUH extends BookingPageFlow{
	...
	public  void TC_158_oneWayInternationalBusiness_JED_AUH(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC_158_oneWayInternationalBusiness_JED_AUH", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC_158_oneWayInternationalBusiness_JED_AUH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			...
			"Validate oneWay International Business_JED_AUH"}};
	}
