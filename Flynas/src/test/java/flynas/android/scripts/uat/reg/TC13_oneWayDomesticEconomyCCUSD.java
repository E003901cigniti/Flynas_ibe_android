...
public class TC13_oneWayDomesticEconomyCCUSD extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataForAndroid"),"FL_WEB_13");

	@Test(dataProvider = "testData",groups={"Android"})
	public  void TC_13_oneWayDomesticEconomyCCUSD(String tripType, String origin, String dest,String deptDate,String origin2,
		...
		try {
			...
			e.printStackTrace();
			Reporter.failureReport("TC13_oneWayDomesticEconomyCCUSD", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			{xls.getCellValue("Trip Type", "Value"),xls.getCellValue("Origin", "Value"),xls.getCellValue("Destination", "Value"),
				...
				"Validate one Way Domestic Economy CC USD"}
			};
	}
