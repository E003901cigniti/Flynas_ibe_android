...
public class TC89_oneWayDomesticFlexCheckIn_ABH_BHH extends BookingPageFlow{
	...
	public  void TC_89_oneWayDomesticFlexCheckIn_ABH_BHH(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC89_oneWayDomesticFlexCheckIn_ABH_BHH", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC89_oneWayDomesticFlexCheckIn_ABH_BHH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate oneWay Domestic Flex CheckIn_ABH_BHH"}};
	}
