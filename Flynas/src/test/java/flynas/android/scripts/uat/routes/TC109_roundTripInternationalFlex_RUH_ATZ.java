...
public class TC109_roundTripInternationalFlex_RUH_ATZ extends BookingPageFlow{
	...
	public  void TC_109_roundTripInternationalFlex_RUH_ATZ(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC109_roundTripInternationalFlex_RUH_ATZ", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC109_roundTripInternationalFlex_RUH_ATZ", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			"Validate RoundTrip International Flex_RUH_ATZ"}};
	}
