...
public class TC49_roundTripInternationalEconomy_JED_AMM extends BookingPageFlow{
	...
	public  void TC_49_roundTripInternationalEconomy_JED_AMM(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC49_roundTripInternationalEconomy_JED_AMM", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC49_roundTripInternationalEconomy_JED_AMM", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip International Economy_JED_AMM"}};
	}
