...
public class TC25_roundTripDomesticEconomy_DMM_ABT extends BookingPageFlow{
	...
	public  void TC_25_roundTripDomesticEconomy_DMM_ABT(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC25_roundTripDomesticEconomy_DMM_ABT", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC25_roundTripDomesticEconomy_DMM_ABT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip Domestic Economy_DMM_ABT"}};
	}
