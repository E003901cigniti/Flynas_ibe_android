...
public class TC27_oneWayDomesticEconomy_ABH_BHH extends BookingPageFlow{
	...
	public  void TC_27_oneWayDomesticEconomy_ABH_BHH(String tripType, String origin, String dest,String deptDate,
		...
		try {
			...
			Reporter.SuccessReport("TC27_oneWayDomesticEconomy_ABH_BHH", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC27_oneWayDomesticEconomy_ABH_BHH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Economy_ABH_BHH"}};
	}
