...
public class TC04_oneWayDomesticEconomy_RUH_MED extends BookingPageFlow{
	...
	public  void TC_04_oneWayDomesticEconomy_RUH_MED(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC04_oneWayDomesticEconomy_RUH_MED", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC04_oneWayDomesticEconomy_RUH_MED", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Economy_RUH_MED"}};
	}
