...
public class TC118_multiCityInternationalFlex_JED_KRT extends BookingPageFlow{
	...
	public  void TC_118_multiCityInternationalFlex_JED_KRT(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC118_multiCityInternationalFlex_JED_KRT", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC118_multiCityInternationalFlex_JED_KRT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate Multicity International Flex_JED_KRT"}};
	}
