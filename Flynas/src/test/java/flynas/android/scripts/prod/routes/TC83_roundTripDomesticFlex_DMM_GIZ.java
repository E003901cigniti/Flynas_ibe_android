...
public class TC83_roundTripDomesticFlex_DMM_GIZ extends BookingPageFlow{
	...
	public  void TC_83_roundTripDomesticFlex_DMM_GIZ(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC83_roundTripDomesticFlex_DMM_GIZ", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC83_roundTripDomesticFlex_DMM_GIZ", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			...
			"Validate RoundTrip Domestic Flex_DMM_GIZ"}};
	}
