...
public class TC15_roundTripDomesticEconomy_JED_TUU extends BookingPageFlow{
	...
	public  void TC_15_roundTripDomesticEconomy_JED_TUU(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC15_roundTripDomesticEconomy_JED_TUU", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC15_roundTripDomesticEconomy_JED_TUU", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip Domestic Economy_JED_TUU"}};
	}
