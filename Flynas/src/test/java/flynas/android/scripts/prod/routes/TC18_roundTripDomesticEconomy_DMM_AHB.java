...
public class TC18_roundTripDomesticEconomy_DMM_AHB extends BookingPageFlow{
	...
	public  void TC_18_roundTripDomesticEconomy_DMM_AHB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC18_roundTripDomesticEconomy_DMM_AHB", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC18_roundTripDomesticEconomy_DMM_AHB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Economy_DMM_AHB"}};
	}
