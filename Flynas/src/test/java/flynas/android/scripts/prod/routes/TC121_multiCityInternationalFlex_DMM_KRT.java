...
public class TC121_multiCityInternationalFlex_DMM_KRT extends BookingPageFlow{
	...
	public  void TC_121_multiCityInternationalFlex_DMM_KRT(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC121_multiCityInternationalFlex_DMM_KRT", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC121_multiCityInternationalFlex_DMM_KRT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate Multicity International Flex_DMM_KRT"}};
	}
