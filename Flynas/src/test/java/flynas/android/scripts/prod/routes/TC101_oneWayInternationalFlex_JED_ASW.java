...
public class TC101_oneWayInternationalFlex_JED_ASW extends BookingPageFlow{
	...
	public  void TC_101_oneWayInternationalFlex_JED_ASW(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC101_oneWayInternationalFlex_JED_ASW", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC101_oneWayInternationalFlex_JED_ASW", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay International Flex_JED_ASW"}};
	}
