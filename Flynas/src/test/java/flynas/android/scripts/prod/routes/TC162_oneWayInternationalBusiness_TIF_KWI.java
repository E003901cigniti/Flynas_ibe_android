...
public class TC162_oneWayInternationalBusiness_TIF_KWI extends BookingPageFlow{
	...
	public  void TC_162_oneWayInternationalBusiness_TIF_KWI(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC162_oneWayInternationalBusiness_TIF_KWI", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC162_oneWayInternationalBusiness_TIF_KWI", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			{xls.getCellValue("Trip Type", "Value"),
				xls.getCellValue("Origin", "Value38"),
				xls.getCellValue("Destination", "Value38"),
			...
			"Validate oneWay International Business_TIF_KWI"}};
	}
