...
public class TC146_roundTripDomesticBusiness_DMM_ELQ extends BookingPageFlow{
	...
	public  void TC_146_roundTripDomesticBusiness_DMM_ELQ(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC146_roundTripDomesticBusiness_DMM_ELQ", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC146_roundTripDomesticBusiness_DMM_ELQ", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			...
			"Validate RoundTrip Domestic Business_DMM_ELQ"}};
	}
