...
public class TC120_multiCityInternationalFlex_MED_KRT extends BookingPageFlow{
	...
	public  void TC_120_multiCityInternationalFlex_MED_KRT(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC120_multiCityInternationalFlex_MED_KRT", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC120_multiCityInternationalFlex_MED_KRT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate Multicity International Flex_MED_KRT"}};
	}
