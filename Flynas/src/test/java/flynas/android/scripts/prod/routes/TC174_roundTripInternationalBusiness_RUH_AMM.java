...
public class TC174_roundTripInternationalBusiness_RUH_AMM extends BookingPageFlow{
	...
	public  void TC_174_roundTripInternationalBusiness_RUH_AMM(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC174_roundTripInternationalBusiness_RUH_AMM", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC174_roundTripInternationalBusiness_RUH_AMM", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Origin", "Value50"),
	    		xls.getCellValue("Destination", "Value50"),
	    		...
	    		"Validate oneWay International Business_RUH_AMM"}};
	}
