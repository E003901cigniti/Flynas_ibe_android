...
public class TC142_roundTripDomesticBusiness_DMM_AHB extends BookingPageFlow{
	...
	public  void TC_142_roundTripDomesticBusiness_DMM_AHB(String tripType, String origin, String dest, 
		...
		Reporter.SuccessReport("TC142_roundTripDomesticBusiness_DMM_AHB", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC142_roundTripDomesticBusiness_DMM_AHB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip Domestic Business_DMM_AHB"}};
	}
