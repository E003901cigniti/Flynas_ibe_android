...
public class TC08_oneWayDomesticEconomy_RUH_URY extends BookingPageFlow{
	...
	public  void TC_08_oneWayDomesticEconomy_RUH_URY(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC08_oneWayDomesticEconomy_RUH_URY", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC08_oneWayDomesticEconomy_RUH_URY", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Economy_RUH_URY"}};
	}
