...
public class TC178_multiCityInternationalBusiness_RUH_HTY extends BookingPageFlow{
	...
	public  void TC_178_multiCityInternationalBusiness_RUH_HTY(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC178_multiCityInternationalBusiness_RUH_HTY", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC178_multiCityInternationalBusiness_RUH_HTY", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Origin", "Value54"),
	    		xls.getCellValue("Destination", "Value54"),
	    		...
	    		"Validate Multicity International Business_RUH_HTY"}};
	}
