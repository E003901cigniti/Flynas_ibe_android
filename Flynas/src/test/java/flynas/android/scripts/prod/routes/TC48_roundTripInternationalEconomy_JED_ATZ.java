...
public class TC48_roundTripInternationalEconomy_JED_ATZ extends BookingPageFlow{
	...
	public  void TC_48_roundTripInternationalEconomy_JED_ATZ(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC48_roundTripInternationalEconomy_JED_ATZ", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC48_roundTripInternationalEconomy_JED_ATZ", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip International Economy_JED_ATZ"}};
	}
