...
public class TC85_roundTripDomesticFlex_DMM_HAS extends BookingPageFlow{
	...
	public  void TC_85_roundTripDomesticFlex_DMM_HAS(String tripType, String origin, String dest, 
		...
		try {
			...
			e.printStackTrace();
			Reporter.failureReport("TC85_roundTripDomesticFlex_DMM_HAS", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			...
			"Validate RoundTrip Domestic Flex_DMM_HAS"}};
	}
