...
public class TC71_oneWayDomesticFlex_RUH_AJF extends BookingPageFlow{
	...
	public  void TC_71_oneWayDomesticFlex_RUH_AJF(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC71_oneWayDomesticFlex_RUH_AJF", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC71_oneWayDomesticFlex_RUH_AJF", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Flex_RUH_AJF"}};
	}
