...
public class TC19_roundTripDomesticEconomy_DMM_YNB extends BookingPageFlow{
	...
	public  void TC_19_roundTripDomesticEconomy_DMM_YNB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC19_roundTripDomesticEconomy_DMM_YNB", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC19_roundTripDomesticEconomy_DMM_YNB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip Domestic Economy_DMM_YNB"}};
	}
