...
public class TC84_roundTripDomesticFlex_DMM_ELQ extends BookingPageFlow{
	...
	public  void TC_84_roundTripDomesticFlex_DMM_ELQ(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC84_roundTripDomesticFlex_DMM_ELQ", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC84_roundTripDomesticFlex_DMM_ELQ", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			...
			"Validate RoundTrip Domestic Flex_DMM_ELQ"}};
	}
