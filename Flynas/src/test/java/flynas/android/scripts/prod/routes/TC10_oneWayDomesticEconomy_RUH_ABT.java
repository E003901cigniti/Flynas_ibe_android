...
public class TC10_oneWayDomesticEconomy_RUH_ABT extends BookingPageFlow{
	...
	public  void TC_10_oneWayDomesticEconomy_RUH_ABT(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC10_oneWayDomesticEconomy_RUH_ABT", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC10_oneWayDomesticEconomy_RUH_ABT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Economy_RUH_ABT"}};
	}
