...
public class TC144_roundTripDomesticBusiness_DMM_MED extends BookingPageFlow{
	...
	public  void TC_144_roundTripDomesticBusiness_DMM_MED(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC144_roundTripDomesticBusiness_DMM_MED", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC144_roundTripDomesticBusiness_DMM_MED", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			...
			"Validate RoundTrip Domestic Business_DMM_MED"}};
	}
