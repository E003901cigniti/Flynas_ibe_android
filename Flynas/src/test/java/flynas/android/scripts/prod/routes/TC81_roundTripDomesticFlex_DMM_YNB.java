...
public class TC81_roundTripDomesticFlex_DMM_YNB extends BookingPageFlow{
	...
	public  void TC_81_roundTripDomesticFlex_DMM_YNB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC81_roundTripDomesticFlex_DMM_YNB", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC81_roundTripDomesticFlex_DMM_YNB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			...
			"Validate RoundTrip Domestic Flex_DMM_YNB"}};
	}
