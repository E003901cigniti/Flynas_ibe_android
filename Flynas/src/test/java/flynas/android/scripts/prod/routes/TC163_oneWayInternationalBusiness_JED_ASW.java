...
public class TC163_oneWayInternationalBusiness_JED_ASW extends BookingPageFlow{
	...
	public  void TC_163_oneWayInternationalBusiness_JED_ASW(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC163_oneWayInternationalBusiness_JED_ASW", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC163_oneWayInternationalBusiness_JED_ASW", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			{xls.getCellValue("Trip Type", "Value"),
				xls.getCellValue("Origin", "Value39"),
				xls.getCellValue("Destination", "Value39"),
			...
			"Validate oneWay International Business_JED_ASW"}};
	}
