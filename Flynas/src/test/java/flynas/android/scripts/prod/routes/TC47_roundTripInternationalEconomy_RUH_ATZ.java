...
public class TC47_roundTripInternationalEconomy_RUH_ATZ extends BookingPageFlow{
	...
	public  void TC_47_roundTripInternationalEconomy_RUH_ATZ(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC47_roundTripInternationalEconomy_RUH_ATZ", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC47_roundTripInternationalEconomy_RUH_ATZ", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip International Economy_RUH_ATZ"}};
	}
