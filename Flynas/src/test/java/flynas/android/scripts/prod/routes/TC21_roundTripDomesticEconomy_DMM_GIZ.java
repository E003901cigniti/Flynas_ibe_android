...
public class TC21_roundTripDomesticEconomy_DMM_GIZ extends BookingPageFlow{
	...
	public  void TC_21_roundTripDomesticEconomy_DMM_GIZ(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC21_roundTripDomesticEconomy_DMM_GIZ", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC21_roundTripDomesticEconomy_DMM_GIZ", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Origin", "Value21"),
	    		xls.getCellValue("Destination", "Value21"),
	    		...
	    		"Validate RoundTrip Domestic Economy_DMM_GIZ"}};
	}
