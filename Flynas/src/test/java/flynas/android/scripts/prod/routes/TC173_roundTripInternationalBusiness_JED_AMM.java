...
public class TC173_roundTripInternationalBusiness_JED_AMM extends BookingPageFlow{
	...
	public  void TC_173_roundTripInternationalBusiness_JED_AMM(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC173_roundTripInternationalBusiness_JED_AMM", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC173_roundTripInternationalBusiness_JED_AMM", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Origin", "Value49"),
	    		xls.getCellValue("Destination", "Value49"),
	    		...
	    		"Validate RoundTrip International Business_JED_AMM"}};
	}
