...
public class TC54_multiCityInternationalEconomy_RUH_HTY extends BookingPageFlow{
	...
	public  void TC_54_multiCityInternationalEconomy_RUH_HTY(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC54_multiCityInternationalEconomy_RUH_HTY", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC54_multiCityInternationalEconomy_RUH_HTY", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate Multicity International Economy_RUH_HTY"}};
	}
