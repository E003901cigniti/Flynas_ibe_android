...
public class TC65_oneWayDomesticFlex_RUH_GIZ extends BookingPageFlow{
	...
	public  void TC_65_oneWayDomesticFlex_RUH_GIZ(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC65_oneWayDomesticFlex_RUH_GIZ", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC65_oneWayDomesticFlex_RUH_GIZ", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Flex_RUH_GIZ"}};
	}
