...
public class TC86_roundTripDomesticFlex_DMM_TUU extends BookingPageFlow{
	...
	public  void TC_86_roundTripDomesticFlex_DMM_TUU(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC86_roundTripDomesticFlex_DMM_TUU", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC86_roundTripDomesticFlex_DMM_TUU", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			...
			"Validate RoundTrip Domestic Flex_DMM_TUU"}};
	}
