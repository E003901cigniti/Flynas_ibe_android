...
public class TC151_oneWayDomesticBusiness_ABH_BHH extends BookingPageFlow{
	...
	public  void TC_151_oneWayDomesticBusiness_ABH_BHH(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC151_oneWayDomesticBusiness_ABH_BHH", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC151_oneWayDomesticBusiness_ABH_BHH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Business_ABH_BHH"}};
	}
