...
public class TC133_oneWayDomesticBusiness_RUH_AJF extends BookingPageFlow{
	...
	public  void TC_133_oneWayDomesticBusiness_RUH_AJF(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC133_oneWayDomesticBusiness_RUH_AJF", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC133_oneWayDomesticBusiness_RUH_AJF", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Business_RUH_AJF"}};
	}
