...
public class TC23_roundTripDomesticEconomy_DMM_HAS extends BookingPageFlow{
	...
	public  void TC_23_roundTripDomesticEconomy_DMM_HAS(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC23_roundTripDomesticEconomy_DMM_HAS", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC23_roundTripDomesticEconomy_DMM_HAS", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip Domestic Economy_DMM_HAS"}};
	}
