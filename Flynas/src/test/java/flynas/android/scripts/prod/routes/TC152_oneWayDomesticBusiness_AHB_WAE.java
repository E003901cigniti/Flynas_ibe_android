...
public class TC152_oneWayDomesticBusiness_AHB_WAE extends BookingPageFlow{
	...
	public  void TC_152_oneWayDomesticBusiness_AHB_WAE(String tripType,String origin, String dest,String deptDate,String origin2,String departure2, String retdate,String Audalt,String Child,String infant, String promo, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC152_oneWayDomesticBusiness_AHB_WAE", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC152_oneWayDomesticBusiness_AHB_WAE", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Business_AHB_WAE"}};
	}
