...
public class TC37_oneWayInternationalEconomy_MED_KWI extends BookingPageFlow{
	...
	public  void TC_37_oneWayInternationalEconomy_MED_KWI(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC37_oneWayInternationalEconomy_MED_KWI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC37_oneWayInternationalEconomy_MED_KWI", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay International Economy_MED_KWI"}};
	}
