...
public class TC132_oneWayDomesticBusiness_RUH_URY extends BookingPageFlow{
	...
	public  void TC_132_oneWayDomesticBusiness_RUH_URY(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC132_oneWayDomesticBusiness_RUH_URY", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC132_oneWayDomesticBusiness_RUH_URY", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Business_RUH_URY"}};
	}
