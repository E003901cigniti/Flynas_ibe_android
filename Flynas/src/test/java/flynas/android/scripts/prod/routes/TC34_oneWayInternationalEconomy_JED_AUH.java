...
public class TC34_oneWayInternationalEconomy_JED_AUH extends BookingPageFlow{
	...
	public  void TC_34_oneWayInternationalEconomy_JED_AUH(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC34_oneWayInternationalEconomy_JED_AUH", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC34_oneWayInternationalEconomy_JED_AUH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay International Economy_JED_AUH"}};
	}
