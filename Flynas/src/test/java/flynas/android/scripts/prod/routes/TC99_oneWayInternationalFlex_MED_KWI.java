...
public class TC99_oneWayInternationalFlex_MED_KWI extends BookingPageFlow{
	...
	public  void TC_99_oneWayInternationalFlex_MED_KWI(String tripType, String origin, String dest,String deptDate, String origin2,
			...
			String email ,String SelectSeat,String paymenttype,String bookingtype,String charity,String Currency, 
			String Description
			) throws Throwable {
		try {
			...
			Reporter.SuccessReport("TC99_oneWayInternationalFlex_MED_KWI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC99_oneWayInternationalFlex_MED_KWI", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Origin", "Value37"),
	    		xls.getCellValue("Destination", "Value37"),
	    		...
	    		"Validate oneWay International Flex_MED_KWI"}};
	}
