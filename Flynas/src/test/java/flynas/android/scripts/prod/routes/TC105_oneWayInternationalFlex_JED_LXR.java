...
public class TC105_oneWayInternationalFlex_JED_LXR extends BookingPageFlow{
	...
	public  void TC_105_oneWayInternationalFlex_JED_LXR(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC105_oneWayInternationalFlex_JED_LXR", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC105_oneWayInternationalFlex_JED_LXR", "Failed");
		}
	}
