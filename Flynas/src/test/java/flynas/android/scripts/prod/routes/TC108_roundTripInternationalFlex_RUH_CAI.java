...
public class TC108_roundTripInternationalFlex_RUH_CAI extends BookingPageFlow{
	...
	public  void TC_108_roundTripInternationalFlex_RUH_CAI(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC108_roundTripInternationalFlex_RUH_CAI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC108_roundTripInternationalFlex_RUH_CAI", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip International Flex_RUH_CAI"}};
	}
