...
public class TC97_oneWayInternationalFlex_JED_KWI extends BookingPageFlow{
	...
	public  void TC_97_oneWayInternationalFlex_JED_KWI(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC97_oneWayInternationalFlex_JED_KWI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC97_oneWayInternationalFlex_JED_KWI", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay International Flex_JED_KWI"}};
	}
