...
public class TC182_multiCityInternationalBusiness_MED_KRT extends BookingPageFlow{
	...
	public  void TC_182_multiCityInternationalBusiness_MED_KRT(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC182_multiCityInternationalBusiness_MED_KRT", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC182_multiCityInternationalBusiness_MED_KRT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate Multicity International Business_MED_KRT"}};
	}
