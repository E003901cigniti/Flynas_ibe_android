...
public class TC46_roundTripInternationalEconomy_RUH_CAI extends BookingPageFlow{
	...
	public  void TC_46_roundTripInternationalEconomy_RUH_CAI(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			payment(paymenttype,"");
			verifyPNRforSadad();
			Reporter.SuccessReport("TC46_roundTripInternationalEconomy_RUH_CAI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC46_roundTripInternationalEconomy_RUH_CAI", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip International Economy_RUH_CAI"}};
	}
