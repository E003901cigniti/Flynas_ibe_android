...
public class TC35_oneWayInternationalEconomy_JED_KWI extends BookingPageFlow{
	...
	public  void TC_35_oneWayInternationalEconomy_JED_KWI(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC35_oneWayInternationalEconomy_JED_KWI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC35_oneWayInternationalEconomy_JED_KWI", "Failed");
		}
	}
