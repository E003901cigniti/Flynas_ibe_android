...
public class TC50_roundTripInternationalEconomy_RUH_AMM extends BookingPageFlow{
	...
	public  void TC_50_roundTripInternationalEconomy_RUH_AMM(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC50_roundTripInternationalEconomy_RUH_AMM", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC50_roundTripInternationalEconomy_RUH_AMM", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip International Economy_RUH_AMM"}};
	}
