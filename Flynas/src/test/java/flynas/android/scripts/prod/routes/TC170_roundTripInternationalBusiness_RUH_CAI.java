...
public class TC170_roundTripInternationalBusiness_RUH_CAI extends BookingPageFlow{
	...
	public  void TC_170_roundTripInternationalBusiness_RUH_CAI(String tripType, String origin, String dest, 
		...
		//Handlepopup();
			...
			Reporter.SuccessReport("TC170_roundTripInternationalBusiness_RUH_CAI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC170_roundTripInternationalBusiness_RUH_CAI", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("Origin", "Value46"),
	    		xls.getCellValue("Destination", "Value46"),
	    		...
	    		"Validate RoundTrip International Business_RUH_CAI"}};
	}
