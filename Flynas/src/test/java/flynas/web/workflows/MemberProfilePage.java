...
public class MemberProfilePage extends BookingPageLocators{
	
	List<WebElement> dateddl = driver.findElements(BookingPageLocators.dd_reg);
	List<WebElement> monthddl = driver.findElements(BookingPageLocators.mm_reg);
	List<WebElement> yearddl = driver.findElements(BookingPageLocators.yy_reg);
	...
	public void ModifyDate(String lable) throws Throwable{
		...
		try{
			...
			Reporter.SuccessReport("Modifying DOB :", "Successful");
		}catch(Exception e){
			Reporter.failureReport("Modifying DOB :", "Unsuccessful");
		}
	}
