...
public class TC09_RTInt1adult1Child1infantBus extends BookingPageFlow{
	
	public static Logger logger = Logger.getLogger(TC09_RTInt1adult1Child1infantBus.class.getName());
	
	public static ConfiguratorSupport configProps=new ConfiguratorSupport("config.properties");
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"TC_09");
	
	@Test(dataProvider = "testData",groups={"Chrome"})
	public void TC_09_RTInt1adult1Child1infantBus(String Username, String Password,String strTripType,String strFlightType,String strOrigin,String strDestination,
			...
			String strNewDate, String charity,String Currency)throws Throwable{
				try{
					String description = "Validate RT Domestic 1adult 1Child 1infant Economy with Extras";
					...
					Reporter.SuccessReport("TC_09_RTInt1adult1Child1infantBus", "Pass");
					
					}catch(Exception e){
						e.printStackTrace();
						Reporter.failureReport("TC_09_RTInt1adult1Child1infantBus", "Fail");
