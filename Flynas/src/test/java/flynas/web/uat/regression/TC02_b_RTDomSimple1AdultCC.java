...
public class TC02_b_RTDomSimple1AdultCC extends BookingPageFlow{
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"TC_02_oneWayDomesticBusiness");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC02b_RTDomSimple1AdultCC(String tripType, 
		...
		try {
			...
			Reporter.SuccessReport("TC02_b_RTDomSimple1AdultCC", "Pass");
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC02_b_RTDomSimple1AdultCC", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate Roundtrip Domestic Simple Class 1 Adult CC booking"
    			}
	    	};
	}
