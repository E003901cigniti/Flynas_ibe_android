...
public class TC02_d_RTDomBusiness1AdultCC extends BookingPageFlow{
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"TC_02_oneWayDomesticBusiness");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC_02d_RTDomBusiness1AdultCC(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC02_d_RTDomBusiness1AdultCC","Pass");
			Reporter.SuccessReport("TC02_d_RTDomBusiness1AdultCC", "Pass");
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC02_d_RTDomBusiness1AdultCC","Fail");
			Reporter.failureReport("TC02_d_RTDomBusiness1AdultCC", "Failed");
		}
	}
