...
public class TC67_PricelockIntlFeeVerificationBookingConfirmationCancellation extends BookingPageFlow{
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"TC_67");
	...
	public  void TC_67A_PricelockDomFeeVerificationBooking(String tripType, String origin, String destination,
		...
		try {			
			...
			updateStatus("IBE_UAT_Reg","TC_67A_PricelockDomFeeVerification","Pass");
			Reporter.SuccessReport("TC_67A_PricelockDomFeeVerification", "Pass");
						
		}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC_67A_PricelockDomFeeVerification","Fail");
			Reporter.failureReport("TC_67A_PricelockDomFeeVerification", "Failed");
		}
	}
