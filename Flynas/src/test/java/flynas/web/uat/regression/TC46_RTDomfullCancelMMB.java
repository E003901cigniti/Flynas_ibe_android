...
public class TC46_RTDomfullCancelMMB extends BookingPageFlow{
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"FL_WEB_45");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC_46_RTDomfullCancelMMB(String tripType, 
		...
		try {
			...
			Reporter.SuccessReport("TC46_RTDomfullCancelMMB", "Pass");
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC46_RTDomfullCancelMMB", "Failed");
		}
	}
