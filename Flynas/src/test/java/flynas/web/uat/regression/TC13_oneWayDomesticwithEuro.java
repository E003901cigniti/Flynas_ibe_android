...
public class TC13_oneWayDomesticwithEuro extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"FL_WEB_14");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC_13_oneWayDomesticwithEuro(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC13_oneWayDomesticwithEuro", "Passed");
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.SuccessReport("TC13_oneWayDomesticwithEuro", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate One way Domestic with Euro"}};
	}
}
