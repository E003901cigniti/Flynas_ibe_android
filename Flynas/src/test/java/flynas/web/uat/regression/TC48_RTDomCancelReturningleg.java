...
public class TC48_RTDomCancelReturningleg extends BookingPageFlow{
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"FL_WEB_45");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC_48_RTDomCancelReturningleg(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC48_RTDomCancelReturningleg","Pass");
			Reporter.SuccessReport("TC48_RTDomCancelReturningleg", "Pass");
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC48_RTDomCancelReturningleg","Fail");
			Reporter.failureReport("TC48_RTDomCancelReturningleg", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate Round trip Domestic booking and return leg cancellation"
    			}
	    	};
	}
