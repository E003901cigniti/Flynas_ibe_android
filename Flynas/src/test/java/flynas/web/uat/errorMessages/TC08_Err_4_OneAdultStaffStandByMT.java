...
public class TC08_Err_4_OneAdultStaffStandByMT extends BookingPageFlow{
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"ErrorMessage_4");
	
	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC_08_Err_4_OneAdultStaffStandByMT(String username,String password,String bookingClass,
		...
		try {
			...
			Reporter.SuccessReport("TC08_Err_4_OneAdultStaffStandByMT", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC08_Err_4_OneAdultStaffStandByMT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {	
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validating Error Message for Conform Booking 1 Adult StaffStandby MultiTrip"}};
	}
}
