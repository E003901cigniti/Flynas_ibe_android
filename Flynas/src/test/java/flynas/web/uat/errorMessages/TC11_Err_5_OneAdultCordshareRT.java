...
public class TC11_Err_5_OneAdultCordshareRT extends BookingPageFlow{

	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"ErrorMessage_5");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC_11_Err_5_OneAdultCordshareRT (String tripType, String origin, String dest, String deptDate,String origin2,String departure2,String retdate,String Audalt,String Child,String infant, 
		...
		try {
			...
			Reporter.SuccessReport("TC11_Err_5_OneAdultCordshareRT", "Passed");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC11_Err_5_OneAdultCordshareRT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate Error Message For One Adult Cordshare CheckIn" }
