...
public class TC22_ConformBooking1Adult1ChildMT extends BookingPageFlow{
ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"ErrorMessage_7");
	
	@Test(dataProvider = "testData",groups={"Chrome"})
	public void TC_22_ConformBooking1Adult1ChildMT(String strTripType,String strFlightType,String strOrigin,String strDestination,
			...
			try{
					...
					Reporter.SuccessReport("TC22_ConformBooking1Adult1ChildMT", "Pass");
					
					
			
					}catch(Exception e){
						e.printStackTrace();
						Reporter.failureReport("TC22_ConformBooking1Adult1ChildMT", "Fail");
		...
		public Object[][] createdata1() {
		    return (Object[][]) new Object[][] {{
    			...
    			"Validating Error Message for Conform Booking 1 Adult 1 Child MT STD Above 48 hours"}};
	}
