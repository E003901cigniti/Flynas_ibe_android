...
public class TC03_Err_2_ConformBooking1Adt1InfantOW extends BookingPageFlow{
ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"ErrorMessage_2");
	
	@Test(dataProvider = "testData",groups={"Chrome"})
	public void TC_03_Err_2_ConformBooking1Adt1InfantOW(String strTripType,String strFlightType,String strOrigin,String strDestination,
			...
			String strNewDate, String charity,String Currency,String description)throws Throwable{
				try{
					...
					inputBookingDetails(trip[0], strOrigin, strDestination, deptdate,origin2,departure2, strReturnDate,
					...
					Reporter.SuccessReport("TC03_Err_2_ConformBooking1Adt1InfantOW", "Pass");
					
					
			
					}catch(Exception e){
						e.printStackTrace();
						Reporter.failureReport("TC03_Err_2_ConformBooking1Adt1InfantOW", "Fail");
		...
		public Object[][] createdata1() {
		    return (Object[][]) new Object[][] {{
    			...
    			"Validating Error Message for Conform Booking 1 Adult 1 infant OW"}};
	}
