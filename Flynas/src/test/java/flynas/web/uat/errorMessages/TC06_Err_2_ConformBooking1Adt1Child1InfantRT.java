...
ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"ErrorMessage_2");
	...
	public void TC_06_Err_2_ConformBooking1Adt1Child1InfantRT(String strTripType,String strFlightType,String strOrigin,String strDestination,
			...
			String strNewDate, String charity,String Currency,String description)throws Throwable{
				try{
					...
					inputBookingDetails(trip[1], strOrigin, strDestination, deptdate,origin2,departure2, strReturnDate,
