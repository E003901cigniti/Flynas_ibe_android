...
public class TC20_ConformBooking1AdultOW extends BookingPageFlow{
ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"ErrorMessage_7");
	
	@Test(dataProvider = "testData",groups={"Chrome"})
	public void TC_20_ConformBooking1AdultOW(String strTripType,String strFlightType,String strOrigin,String strDestination,
			...
			try{
					...
					inputBookingDetails(trip, strOrigin, strDestination, depdate,origin2,departure2, "",
					...
					Reporter.SuccessReport("TC20_ConformBooking1AdultOW", "Pass");
					
					
			
					}catch(Exception e){
						e.printStackTrace();
						Reporter.failureReport("TC20_ConformBooking1AdultOW", "Fail");
		...
		public Object[][] createdata1() {
		    return (Object[][]) new Object[][] {{
    			...
    			"Validating Error Message for Conform Booking 1 Adult One Way STD Above 48 hours"}};
	}
