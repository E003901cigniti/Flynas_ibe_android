...
public class TC60_multicityInternationalEconomy_RUH_BAH extends BookingPageFlow {
	...
	public  void TC_60_multicityInternationalEconomy_RUH_BAH( String bookingClass, String bundle,
			String mobilenum,
			String paymentType,
			String newDate,
		...
		try {
			...
			e.printStackTrace();
			Reporter.failureReport("TC60_multicityInternationalEconomy_RUH_BAH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate MultiCity International Economy_RUH_BAH"}};
	}
