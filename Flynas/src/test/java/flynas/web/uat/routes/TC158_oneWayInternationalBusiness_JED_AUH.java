...
public class TC158_oneWayInternationalBusiness_JED_AUH extends BookingPageFlow {
	...
	public  void TC_158_oneWayInternationalBusiness_JED_AUH( String bookingClass, String bundle,
			String mobilenum,
			String paymentType,
			String newDate,
		...
		try {
			...
			Reporter.SuccessReport("TC158_oneWayInternationalBusiness_JED_AUH", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC158_oneWayInternationalBusiness_JED_AUH", "Failed");
		}
	}
