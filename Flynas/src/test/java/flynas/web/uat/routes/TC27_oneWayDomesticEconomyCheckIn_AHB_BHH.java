...
public class TC27_oneWayDomesticEconomyCheckIn_AHB_BHH extends BookingPageFlow{
	...
	public  void TC_27_oneWayDomesticEconomyCheckIn_AHB_BHH( String bookingClass, String bundle,
			String mobilenum,
			String paymentType,
			String newDate,
		...
		try {
			...
			Reporter.SuccessReport("TC27_oneWayDomesticEconomyCheckIn_ABH_BMM", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC27_oneWayDomesticEconomyCheckIn_ABH_BMM", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Economy CheckIn_ABH_BMM"}};
	}
