...
public class TC151_oneWayDomesticBusinessCheckIn_AHB_BHH extends BookingPageFlow{
	...
	public  void TC_151_oneWayDomesticBusinessCheckIn_AHB_BHH( String bookingClass, String bundle,
			String mobilenum,
			String paymentType,
			String newDate,
		...
		try {
			...
			Reporter.SuccessReport("TC151_oneWayDomesticBusinessCheckIn_AHB_BHH", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC151_oneWayDomesticBusinessCheckIn_AHB_BHH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Business CheckIn_ABH_BMM"}};
	}
