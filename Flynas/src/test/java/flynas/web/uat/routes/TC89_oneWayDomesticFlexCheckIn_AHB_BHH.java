...
public class TC89_oneWayDomesticFlexCheckIn_AHB_BHH extends BookingPageFlow{
	...
	public  void TC_89_oneWayDomesticFlexCheckIn_AHB_BHH( String bookingClass, String bundle,
			String mobilenum,
			String paymentType,
			String newDate,
		...
		try {
			...
			Reporter.SuccessReport("TC89_oneWayDomesticFlexCheckIn_AHB_BHH", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC89_oneWayDomesticFlexCheckIn_AHB_BHH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate oneWay Domestic Flex CheckIn_ABH_BMM"}};
	}
