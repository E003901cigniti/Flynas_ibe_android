...
public class TC145_roundTripDomesticBusiness_DMM_GIZ extends BookingPageFlow{
	...
	public  void TC_145_roundTripDomesticBusiness_DMM_GIZ( String bookingClass, String bundle,
			String mobilenum,
			String paymentType,
			String newDate,
		...
		try {
			...
			Reporter.SuccessReport("TC145_roundTripDomesticBusiness_DMM_GIZ", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC145_roundTripDomesticBusiness_DMM_GIZ", "Failed");
		}
	}
