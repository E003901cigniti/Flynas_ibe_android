...
public class TC77_roundTripDomesticFlex_JED_TUU extends BookingPageFlow{
	...
	public  void TC_77_roundTripDomesticFlex_JED_TUU( String bookingClass, String bundle,String mobilenum,String paymentType,
		...
		try {
			...
			Reporter.SuccessReport("TC77_roundTripDomesticFlex_JED_TUU", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC77_roundTripDomesticFlex_JED_TUU", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip Domestic Flex_JED_TUU"}};
	}
}
