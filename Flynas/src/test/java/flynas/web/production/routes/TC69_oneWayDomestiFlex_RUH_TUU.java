...
public class TC69_oneWayDomestiFlex_RUH_TUU extends BookingPageFlow{
	...
	public  void TC_69_oneWayDomestiFlex_RUH_TUU( String bookingClass,
		...
		try {TestEngine.testDescription.put(HtmlReportSupport.tc_name, Description);
			...
			Reporter.SuccessReport("TC69_oneWayDomestiFlex_RUH_TUU", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC69_oneWayDomestiFlex_RUH_TUU", "Failed");
		}
	}
