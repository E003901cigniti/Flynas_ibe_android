...
public class TC88_oneWayDomesticFlex_AHB_ABT extends BookingPageFlow{
	...
	public  void TC_88_oneWayDomesticFlex_AHB_ABT( String bookingClass, String bundle, 
			String mobilenum,
			String paymentType,
			String newDate,
		...
		try {
			...
			Reporter.SuccessReport("TC88_oneWayDomesticFlex_AHB_ABT", "Pass");
			...
			Reporter.failureReport("TC88_oneWayDomesticFlex_AHB_ABT", "Failed");
		}
	}
