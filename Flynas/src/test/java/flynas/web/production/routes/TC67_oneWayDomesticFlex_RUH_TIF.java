...
public class TC67_oneWayDomesticFlex_RUH_TIF  extends BookingPageFlow{
	...
	public  void TC_67_oneWayDomesticFlex_RUH_TIF( String bookingClass, String bundle, 
			String mobilenum,
			String paymentType,
			String newDate,
		...
		try {TestEngine.testDescription.put(HtmlReportSupport.tc_name, Description);
			...
			Reporter.SuccessReport("TC67_oneWayDomesticFlex_RUH_TIF", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC67_oneWayDomesticFlex_RUH_TIF", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate OneWay Domestic Flex_RUH_TIF"}};
	}
