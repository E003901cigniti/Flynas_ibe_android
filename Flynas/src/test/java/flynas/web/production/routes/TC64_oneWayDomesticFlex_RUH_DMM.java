...
public class TC64_oneWayDomesticFlex_RUH_DMM extends BookingPageFlow{
	...
	public  void TC_64_oneWayDomesticFlex_RUH_DMM( String bookingClass, String bundle, 
			String mobilenum,
			String paymentType,
			String newDate,
		...
		try {TestEngine.testDescription.put(HtmlReportSupport.tc_name, Description);
			...
			Reporter.SuccessReport("TC64_oneWayDomesticFlex_RUH_DMM", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC64_oneWayDomesticFlex_RUH_DMM", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate OneWay Domestic Flex_RUH_DMM"}};
	}
