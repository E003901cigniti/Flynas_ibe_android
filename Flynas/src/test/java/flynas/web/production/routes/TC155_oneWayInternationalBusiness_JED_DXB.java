...
public class TC155_oneWayInternationalBusiness_JED_DXB extends BookingPageFlow{
	...
	public  void TC_155_oneWayInternationalBusiness_JED_DXB( String bookingClass,
			String mobilenum,
			String paymentType,
			String newDate,
		...
		try {
			...
			e.printStackTrace();
			Reporter.failureReport("TC155_oneWayInternationalBusiness_JED_DXB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		xls.getCellValue("newDate", "Value3"),
	    		xls.getCellValue("Total Passenger", "Value"),
	    		xls.getCellValue("Flight Type", "Value2"),
	    		"Validate oneWay International Business_JED_DXB"}};
	}
