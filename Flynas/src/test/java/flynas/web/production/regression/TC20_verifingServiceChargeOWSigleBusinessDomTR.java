...
public class TC20_verifingServiceChargeOWSigleBusinessDomTR extends BookingPageFlow {
	...
	public  void TC_20_verifingServiceChargeOWSigleBusinessDomTR( String username,String password,String bookingClass,String mobilenum,
		...
		try {
			...
			Reporter.SuccessReport("TC20_verifingServiceChargeOWSigleBusinessDomTR", "Pass");
		}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.SuccessReport("TC20_verifingServiceChargeOWSigleBusinessDomTR", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Verifing Service Charge One Way Sigle Business Domestic TR"}};
	}
