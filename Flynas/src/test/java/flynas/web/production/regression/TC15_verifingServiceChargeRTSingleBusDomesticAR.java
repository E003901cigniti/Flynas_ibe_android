...
public class TC15_verifingServiceChargeRTSingleBusDomesticAR extends BookingPageFlow {
	...
	public  void TC_15_verifingServiceChargeRTSingleBusDomesticAR( String username,String password,String bookingClass,
		...
		try {
			...
			e.printStackTrace();
			Reporter.SuccessReport("TC15_verifingServiceChargeRTSingleBusDomesticAR", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Verifing Service Charge RT Single Business Domestic AR"}};
	}
